...
train_dataset = tf.data.TFRecordDataset('tfrecords_noh/train.tfrecord.gz', compression_type='GZIP')\
...
valid_dataset = tf.data.TFRecordDataset('tfrecords_noh/valid.tfrecord.gz', compression_type='GZIP')\
    .map(parse_example, num_parallel_calls=tf.data.experimental.AUTOTUNE)\
...
if __name__ == "__main__":
    ...
    model_name = '20200925_stability_newpreprocessor'
