...
num_train = np.logspace(2, 4.9, num=10,dtype=int)[runid]

model_name = 'train_number/n_{}'.format(num_train)
print(model_name)
...
train_dataset = tf.data.TFRecordDataset('tfrecords_redox/train.tfrecord.gz', compression_type='GZIP').take(num_train)\
